...
function UserNamePage() {
  ...
  //{profile,followersLength,followingLength,errorLoading}
  ...
  //load {profile,followersLength,followingLength,errorLoading}
  useEffect(() => {
    const getProfile = async () => {
      try {
        ...
        setError("getting profile details");
      }
    };
    getProfile();
  }, [params.username]);
  ...
  useEffect(() => {
    ...
    getPosts();
  }, [params.username]); //only once on the first component render
